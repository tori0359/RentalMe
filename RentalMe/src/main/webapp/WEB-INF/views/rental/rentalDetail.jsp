										...
										<div class="modal-content">
											...
											<div class="modal-body">
												...
												<div class="form-group">
											    	...
											    	<textarea class="form-control" id="agree" name="agree" readonly="readonly">
											    	고객님의 렌탈상품 상담과 관련하여 성실하게 답변 및 안내해 드리기 위해 필요한 최소한의 개인정보를 수집하고 있습니다. 이에개인정보의 수집 및 이용에 관하여 아래와 같이 고지하오니 충분히 읽어보신 후 동의하여 주시기 바랍니다. 
						...
						<div id="area2">
							...
							<div id="info2">
								...
								<ul>
									...
									<ul>
										<li><h4>신청상품의 안전한 배송을 위해, 고객님께서 주문시 지정한 배송장소 이외, 제3자 전달이나 임의장소 배송은 제공하지 않습니다.</h4></li>
										<li><h4>신청하신 제품의 전문설치기사가 배달, 설치해 드립니다. (도서 산간지역은 제한될 수 있습니다.) </h4></li>
										<li><h4>배송전일 또는 당일 오전에 배송설치기사가 고객님께 연락을 드린 후 배송설치 해 드립니다. </h4></li>
										<li><h4>신청상품은 7일~14일 이내 제품을 받아볼 수 있습니다. (단, 제조사 재고현황에 따라 배송일은 예고없이 변경될 수 있습니다.) </h4></li>
										<li><h4>에어컨 등 계절별 특수상품은 제조사 재고현황 및 설치기사 사정에 따라 14일~30일 이후 배송 될 수 있습니다. </h4></li>
										<li><h4>동일품목의 폐가전 무료수거가 가능합니다. (단, 에어컨은 별도 확인 필요) </h4></li>
										<li><h4>설치상품 주문 시, 설치환경을 반드시 체크해 주시기 바랍니다. (제품의 크기와 설치공간의 크기, 출입문 사이즈 등의 체크) </h4></li>
									</ul>
									<br><br>
									<li id="li1"><span class="glyphicon glyphicon-wrench" aria-hidden="true"></span> A/S조건</li>
									<ul>
										<li ><h4 style="line-height:30px;">신청하신 렌탈상품은 제조사의 A/S 정책을 따르며, 제조사의 무상 A/S기간동안 제조사를 통해 A/S를 받으실 수 있습니다.<br/>(1년 무상 A/S, 이후 유상 A/S 등, 단 고객과실일 경우는 유상 A/S)</h4></li>
										<li><h4>회사가 지정한 일부 상품에 한해, 3년 무상 A/S 서비스 (제조사 무상 A/S 1년 + 회사 무상 A/S 2년)가 제공됩니다. </h4></li>
										<li><h4>“무상A/S 3년” 이미지가 표기된 상품에 한하며, 1년이내는 제조사로, 1년이후~3년까지는 당사 고객센터로 신청바랍니다.</h4></li>
										<li><h4>“무상A/S 3년” 혜택은 아래의 경우 제공되지 않습니다.</h4></li>
										<li id="li2"><h4>가. 제품하자가 아닌 고객과실에 의한 파손 등의 경우</h4></li>
										<li id="li2"><h4>나. 상품품질 보증서에 기재된 상품품질보증의 상태, 조건, 혹은 이유에 해당하지 않는 것으로 인한 경우</h4></li>
										<li id="li2"><h4>다. 제조사의 상품품질보증기간에 의한 무상수리 또는 제조사로부터 기타 무상수리가 가능한 경우</h4></li>
										<li id="li2"><h4>라. 사용자가 임의로 상품을 개조,조립, 변경한 경우</h4></li>
										<li id="li2"><h4>마. 상품을 수리 받기위해 발생한 고객의 교통비용 등</h4></li>
									</ul>
									<br><br>
								</ul>
							</div>
						...
						<div id="area3">
							...
							<div id="info3">
								...
								<ul>
									...
									<ul>
										<li><h4>교환/반품은 제품 수령일로부터 7일 이내에 가능합니다.</h4></li>
										<li><h4>다만, 제품이 표시.광고의 내용과 다르거나 제품의 불량, 하자 등 계약내용과 다르게 이행된 경우, 제품수령일로부터 3개월 이내, 그 사실을 안 날 또는 알 수 있었던 날로부터 30일 이내에 교환/반품이 가능합니다.</h4></li>
										<li><h4>제품을 교환/반품 하시기 전, 고객센터로 미리 연락을 주셔야 합니다.</h4></li> 
										<li><h4>제품 자체에 하자가 있는 경우, 각 제조사 서비스 센터로 접수하신 후, A/S기사의 판정을 거친 후, 소비자 분쟁해결기준에 의거하여 교환/환불/수리해 드립니다.</h4></li>
									</ul><br><br>
									<li id="li1"><span class="glyphicon glyphicon-usd" aria-hidden="true"></span> 반품 회수(배송)비용</h4></li>
									<ul>
										<li><h4>제품이 표기, 광고의 내용과 다르거나 제품의 불량, 하자 등 계약내용과 다르게 이행된 경우에는 고객님께서 반품회수(배송)비용을 부담하실 필요가 없으나, 그 외 고객님의 단순 변심 및 제품에 대한 주관적이 불만족으로 인하여 반품을 진행하시는 경우 고객님께서 반품회수(배송) 비용을 부담하셔야 합니다.</h4></li>
									</ul><br><br>
									<li id="li1"><span class="glyphicon glyphicon-remove-circle" aria-hidden="true"></span> 교환/반품 불가 안내</li>
									<ul>
										<li><h4>제품 배송완료 후 고객님이 제품포장을 개봉하여 사용한 경우 또는 제품 배송완료 후 고객님께서 제품의 하자없음을 확인한 후 설치가 완료된 경우 등 고객님의 책임 있는 사유로 상품이 멸실 또는 훼손된 경우<br>(단, 단순히 상품의 내용을 확인하기 위해 포장 등을 훼손한 경우는 제외)</h4></li>
										<li><h4>고객님의 사용 또는 일부 소비로 제품의 가치가 현저히 감소된 경우</h4></li>
										<li><h4>패키지 상품의 경우 구성상품 일부의 개봉/설치/사용으로 상품가치가 현저히 감소된 경우</h4></li>
										<li><h4>시간이 경과 되어 재판매가 곤란할 정도로 상품가치가 상실된 경우</h4></li>
										<li><h4>설치 완료 상품에 하자가 없는 경우</h4></li>
										<li><h4>상품 등의 내용이 표시/광고 내용 및 계약내용과 같고, 별도의 하자가 없음에도 단순변심으로 인한 교환을 요구하는 경우</h4></li>
										<li><h4>기타, '전자상거래 등에서의 소비자 보호에 관한 법률'등 관계법령이 정하는 교환/반품제한 사유에 해당되는 경우</h4></li>
										<li><h4>그 밖에 교환/반품을 인정하는 경우, 통신판매업자에게 회복할 수 없는 중대한 피해가 예상되는 경우</h4></li>
									</ul><br><br>
									<li id="li1"><span class="glyphicon glyphicon-list" aria-hidden="true"></span> 해재시 위약관련 사항[2019년 10월 1일 이후 계약건부터 적용]</h4></li>
									<ul>
										<li><h4>렌탈계약 해제 시, “정상적인 렌탈제품의 반납”여부에 따라, 아래의 해지위약관련 비용을 납부하셔야 합니다.</h4></li>
										<li><h4>“정상적인 렌탈제품의 반납”이란 반납된 제품이 정상 작동되고, 반납된 제품의 본품 및 구성품이 분실,파손없이 전부 반납된 경우를 말합니다. </h4></li>
										<li id="li2"><h4>가. 정상적인 렌탈제품을 반납하고 해지할 경우 해지위약 관련 비용</h4></li>
										<li id="li2"><h4>&nbsp;&nbsp; 1) 해지시점의 연체 렌탈료, 연체이자 (발생 시)</h4> </li>
										<li id="li2"><h4>&nbsp;&nbsp; 2) 중도해지 위약금 : 중도해지일 현재 잔여렌탈료 합계금액의 30% 금액</h4></li>
										<li id="li2"><h4>&nbsp;&nbsp; 3) 면제받았던 설치비용(가입비+등록비 포함) : 20만원</h4> </li>
										<li id="li2"><h4>&nbsp;&nbsp; 4) 회수비용 : 10만원~30만원 (제품별 상이함) </h4></li>
										<li id="li2"><h4>나. 정상적인 렌탈제품을 반납하지 않고 해지할 경우 해지위약 관련 비용 </h4></li>
										<li id="li2"><h4>&nbsp;&nbsp; 1) 해지시점의 연체렌탈료, 연체이자 (발생 시) </h4></li>
										<li id="li2"><h4>&nbsp;&nbsp; 2) 잔여렌탈료 합계금액의 100% 금액 </h4></li>
										<li id="li2"><h4>다. 잔여렌탈료 합계금액은 “월 렌탈료 x 잔여약정월 (단, 중도해지일이 포함된 월의 렌탈료는 일할계산)”로 계산됩니다.</h4></li>
									</ul>
									<br><br>
								</ul>
							</div>
