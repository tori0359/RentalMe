...
<body>
	...
	<div id="actList">
		<div id="actMenuDiv">
			...
			<div class="hr"
				style="clear: both; height: 3px; background-color: black;"></div>
		</div>
		<div id="actRunList">
					...
					<div class="col-md-10 col-md-offset-1">
						<div style="height: 100%;" class="actCon">
							...
							<div class="col-md-3" id="contentDiv">
								...
								<input id="hiddenCd" type="hidden" value="${bean.gdsCd}" /> <input
									class="hiddenPrice" type="hidden" value="${bean.gdsStPrice}" />
								<div>
									<h4 id="brandNmStyle">${bean.brandNm}</h4>
								</div>
								<div>
									<h2 style="font-family: 'nanumEB'">${bean.gdsNm }</h2>
								</div>
								<div>
									<p style="font-family: 'nanumB';">${bean.content }</p>
								</div>
								<br>
								<div>
									<h4 class="text">
										<span class="color">시작가</span><span class="startPrice">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;<fmt:formatNumber
												pattern="#,###.##"> ${bean.gdsStPrice }</fmt:formatNumber> 원
										</span>
									</h4>
								</div>
								<div>
									<h4 class="text">
										<span class="color">경매 시작 시간</span>&emsp;&emsp;&emsp;<span
											class="span"> ${bean.actStTime }</span>
									</h4>
								</div>
							</div>
						</div>
		...
		<div style="background-color: rgba(128, 128, 128, 0.2);"
			...
			<c:forEach items="${alist2}" var="bean">
				<div class="row wrapper">
					<div class="col-md-10 col-md-offset-1">
						<div style="height: 100%;" id="actCon">
							<div id="end"
								style="opacity: 1; position: absolute; height: 40px; width: 60%; padding: 30px; margin-left: 20%; z-index: 100;">
								<p>경매 종료</p>
							</div>
							<div class="col-md-4" id="imgDiv"
								style="opacity: 0.2; padding: 20px 0px 20px 50px;">
								<img class="ordimg" src="/imgs/bed1.jpg" />
							</div>
							<div style="opacity: 0.2;" class="col-md-3" id="contentDiv">
								...
								<div>
									<h4 class="text">
										<span>시작가</span><span>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;<fmt:formatNumber
												pattern="#,###.##"> ${bean.gdsStPrice }</fmt:formatNumber> 원
										</span>
									</h4>
								</div>
								<div>
									<h4 class="text">
										<span>경매 시작 시간</span>&emsp;&emsp;&emsp;<span class="span">
											${bean.actStTime }</span>
									</h4>
								</div>
							</div>
				...
				<div class="hr"
					style="clear: both; height: 2px; background-color: darkgrey;"></div>
			</c:forEach>
		</div>
	</div>
</body>
