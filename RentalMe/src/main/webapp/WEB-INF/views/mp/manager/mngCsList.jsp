									...
									<tbody>
										...
										<c:forEach items="${alist}" var="bean">
											<tr>
												...
												<td>공지</td>
												<td style="text-align:left;"><a style="text-decoration:none" href="${pageContext.request.contextPath}/cs/csNoticeDetail?noticNo=${bean.noticNo}&csGbCd=${bean.csGbCd}">${bean.sub}</a></td>
												<td>${bean.regDt}</td>
