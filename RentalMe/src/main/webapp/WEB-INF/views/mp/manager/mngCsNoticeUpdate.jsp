...
<form action="/mp/mng/csNoticeUpdate" method="post">
      <h2>공지사항 수정</h2>
        <table class="table" id="daeContent" >
            <tr>
                <td style="width:25%;"><label>작 성 자</label></td>
                <td style="text-align:left;">관 리 자</td>
            </tr>
            <tr>
               <td><label>글 번 호</label></td>
               <td style="text-align:left;"><input style="text-align:left;" type="hidden" value="${detail.noticNo}" name="noticNo">${detail.noticNo}</td>
            </tr>
            <tr>
                <td><label>분류</label></td>
                <td style="text-align:left;"><input type="hidden" name="csGbCd" value="${detail.csGbCd}">
                    공지사항
                </td>
            </tr>
            <tr>
                <td style="vertical-align: middle;"><label>제목</label></td>
                <td style="text-align:left;"><input type="text" name="sub" value="${detail.sub}" id="text" class="form-control"></td>
            </tr>
            <tr>
