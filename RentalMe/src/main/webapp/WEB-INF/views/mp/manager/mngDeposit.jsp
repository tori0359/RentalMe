...
<head>
	<meta charset="UTF-8">
	<title>RentalMe - 예치금관리 리스트</title>
		...
		<div class="dashboard-wrapper">
		          <div class="container-fluid  dashboard-content">	
		              ...
		              <div class="row">
		                  ...
		                  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
		                      <div class="card">
		                          <h5 class="card-header">예치금 목록</h5>
		                          <div class="card-body">
											...
											<tbody>
												<c:forEach items="${alist }" var="bean">
													<tr class="usedTableTrClick"
														onclick="location.href='/mp/mng/deposit/${bean.mbNo }'">
														<td>${bean.mbNo }</td>
														<td>${bean.userNm }</td>
														<td><fmt:formatNumber value="${bean.remnDeposit}"
																pattern="#,###.##" />원</td>
														<fmt:parseDate value="${bean.chgDt }" var="time"
															pattern="yyyy-MM-dd HH:mm:ss.S" />
														<td><fmt:formatDate value="${time}"
